      ...
      {channelId && (
        <>
          ...
          <motion.aside
            ...
            className="fixed inset-y-0 right-0 z-50 flex w-full max-w-lg flex-col border-l border-border bg-surface shadow-2xl pt-[env(safe-area-inset-top)] pb-[env(safe-area-inset-bottom)]"
          >
            {body}
          </motion.aside>
        </>
